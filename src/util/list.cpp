...
{
    if (!list_head_alone(p_new) || list_head_alone(p_old))
        return false;
...
{
    if (list_head_alone(p_entry1) || list_head_alone(p_entry2))
        return false;
...
{
    if (list_head_alone(p_new) || list_head_alone(p_pos))
        return false;
